    ...
    <Flex justify="center" align="center" m="2rem" py="10px" overflow="hidden">
      <Box position="relative" w="100%" maxW="1200px" h="500px" borderRadius="25px" overflow="hidden">
        ...
        <Box position="absolute" top={["5rem", "7rem", "7rem"]} left={["0", "1rem", "0rem", "4rem"]} zIndex={10}>
          <Text fontSize={["25px", "25px", "35px"]} w={["200px", "300px", "300px", "400px"]} color="white" className={oswald400.className} p={4}>
            Hot and fresh Food in 30 minutes—or a discount on your next order!
          </Text>
          <Flex justify="center" align="center">
            <Button as={Link} href="/shop" mt="4" leftIcon={<MdLocalShipping size="20px" />} colorScheme="teal" w={["120px", "150px", "200px"]}>
              ORDER NOW
            </Button>
          </Flex>
        </Box>
